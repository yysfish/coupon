...
import com.wx.common.constant.CouponConst;
...
public class BaseController {
	...
	public ResponseModel getSuccessModel() {
		...
		model.setCode(CouponConst.SUCCESS_CODE);
		model.setMsg(CouponConst.SUCCESS_MSG);
		return model;
	}
	...
	public ResponseModel getErrorModel(Exception e) {
		if (e instanceof ResponseCodeException) {
			...
			return new ResponseModel(CouponConst.ERROR_CODE, CouponConst.ERROR_MSG);
		}
	}
}
